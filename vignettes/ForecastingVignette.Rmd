...
```{r }
#require(hetGP4cast)
devtools::install_github("maikeh7/hetGP4cast")
```



```{r include=FALSE}
#source("C:/Users/Maike/Box Sync/DEEP_LEARNING/SurrogateModeling/Important_code/hetGP4cast/R/fit_hetgp.R")
#source("C:/Users/Maike/Box Sync/DEEP_LEARNING/SurrogateModeling/Important_code/hetGP4cast/R/predict_hetgp.R")
```
...
reals = rmultnorm(n = 200, mu = mu, sigma = sigma)
matplot(t(reals), type= "l", col = "gray")
```
...
matplot(t(reals), type= "l", col = "gray",
        ylab = "Mean", xlab = "DOY", ylim = c(24, 32))
lines(mymean, type = "l")
lines(Qupper, lty=2)
lines(QLower, lty=2)

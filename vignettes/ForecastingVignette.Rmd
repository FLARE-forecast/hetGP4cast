...
* `covmat`: the predictive covariance matrix (if `save_covmat` = TRUE; otherwise `covmat` will be `NULL`
...
list(pred_df = finaldf, covmat = covmat, df = df, preds4plotting = mypreds,
...
matplot(t(reals), type= "l", col = "gray", ylab = "Mean", xlab = "DOY")
lines(mymean, type = "l")
lines(Qupper, lty=2)
lines(QLower, lty=2)
```
